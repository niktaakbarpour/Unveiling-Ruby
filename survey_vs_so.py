...
# # print(f"Shapiro-Wilk Test for SO Data: Statistic = {stat_so}, p-value = {p_so}")
# # print(f"Shapiro-Wilk Test for Survey Data: Statistic = {stat_survey}, p-value = {p_survey}")

# # alpha = 0.05

# # if p_so > alpha:
# #     print("SO data average looks normally distributed.")
# # else:
# #     print("SO data average does not look normally distributed.")

# # if p_survey > alpha:
# #     print("Survey data average looks normally distributed.")
# # else:
# #     print("Survey data average does not look normally distributed.")
...
# # print("Paired Sample T-test Statistic:", t_statistic)
...
# plt.grid(True, linestyle='--', alpha=0.7)
# # print(type(combined_df['category']))
...
# # print(combined_df, stackoverflow_df)
...
# print(np.corrcoef(combined_df['avg_time'], combined_df['response_time'])[0,1])

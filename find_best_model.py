...
class TopicModeling:
    ...
    def train(self, min_cluster_sizes):
        ...
        for min_cluster_size in min_cluster_sizes:
            print(f"Training with min_cluster_size: {min_cluster_size}")
            ...
            if not topics or not topics[0]:
                print("No topics found or topics list is empty.")
                continue
            ...
            print(f"Training completed with min_cluster_size: {min_cluster_size}, Number of Topics: {len(set(topics))-1}, Coherence Score: {coherence_umass}")  
...
#         vectorizer_model = CountVectorizer(ngram_range=(1, config_defaults['ngram_range']), stop_words='english')
#         print("after vectorizer model")

#         ctfidf_model = ClassTfidfTransformer(reduce_frequent_words=config_defaults['reduce_frequent_words'])
#         print("after ctfidf")
#         representation_model = KeyBERTInspired()
#         print("keybert inspired")
#         topic_model = BERTopic(embedding_model=embedding_model,
#                                umap_model=umap_model,
#                                hdbscan_model=hdbscan_model,
#                                vectorizer_model=vectorizer_model,
...
#         print("Document info:")
#         print(document_info)
#         print("Type of document_info:", type(document_info))
...
#         # print("Coherence CV:", coherence_cv)
#         # print("Topic Number:", topic_model.get_topic_info().shape[0] - 1)
#         # print("Uncategorized Post Number:", topic_model.get_topic_info().at[0, 'Count'])
#         print("get coherence")
#         topic_info = topic_model.get_topic_info()
#         print("getting info")
#         topic_df = pd.DataFrame(topic_info, columns=['Topic', 'Count', 'Name', 'Representation', 'Representative_Docs'])

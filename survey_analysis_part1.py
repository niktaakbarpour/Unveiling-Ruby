...
#     # print(col, count_1, count_2, count_3, count_4, count_5)
...
for idx, category in enumerate(sorted_categories):
    ...
    print(colors[0], colors[1], colors[18], colors[5], colors[4])
    ...
    plt.text(-6.5, idx, f'{display_category}', va='center', ha='right', color='black', fontsize=14)
    plt.text(norm_count_1 / 2, idx, f'{(counts["1"] / total) * 100:.1f}%', va='center', color='black', fontsize=12)
    plt.text(norm_count_1 + norm_count_2 / 2, idx, f'{(counts["2"] / total) * 100:.1f}%', va='center', color='black', fontsize=12)
    plt.text(norm_count_1 + norm_count_2 + norm_count_3 / 2, idx, f'{(counts["3"] / total) * 100:.1f}%', va='center', color='black', fontsize=12)
    plt.text(norm_count_1 + norm_count_2 + norm_count_3 + norm_count_4 / 2, idx, f'{(counts["4"] / total) * 100:.1f}%', va='center', color='black', fontsize=12)
    plt.text(norm_count_1 + norm_count_2 + norm_count_3 + norm_count_4 + norm_count_5 / 2, idx, f'{(counts["5"] / total) * 100:.1f}%', va='center', color='black', fontsize=12)

    plt.text(-0.5, idx, f'{percent_1_2:.1f}%', va='center', ha='right', color='black', fontsize=12)
    plt.text(norm_count_1 + norm_count_2 + norm_count_3 + norm_count_4 + norm_count_5 + 0.5, idx, f'{percent_4_5:.1f}%', va='center', ha='left', color='black', fontsize=12)
...
plt.tight_layout()
# plt.subplots_adjust
# plt.savefig('survey_part1_step3.pdf')
plt.show()

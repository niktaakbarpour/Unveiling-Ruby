...
def main():
    ...
    logger.info(f"The average number of views per topic has been saved to {output_file}")
    ...
    logger.info(f"The average number of views per topic has been saved to {average_views}")

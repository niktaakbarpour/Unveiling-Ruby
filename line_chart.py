...
#         print(f"No data found for the topic_name: {topic}")
#         continue
...
#     total_questions_per_year = df.groupby(['Year', 'Month']).size()
#     total_questions_per_year = total_questions_per_year.reset_index(name='Count')
#     total_questions_per_year['Date'] = pd.to_datetime(total_questions_per_year[['Year', 'Month']].assign(DAY=1))
#     total_questions_per_year = total_questions_per_year.sort_values('Date')
...
#     merged_df = pd.merge(topic_questions_per_month, total_questions_per_year, on='Date', suffixes=('_monthly', '_yearly'))

#     merged_df['Percentage'] = (merged_df['Count_monthly'] / merged_df['Count_yearly']).fillna(0) * 100


#     import pymannkendall as mk

#     # mk_result_count = mk.original_test(topic_questions_per_month['Count'])
#     # print("Mann-Kendall Test for Count:")
#     # print("Trend: ", mk_result_count.trend)  # Increasing or Decreasing
#     # print("p-value: ", mk_result_count.p)  # p-value
#     # print("Z-value: ", mk_result_count.z)  # Z-value

#     mk_result_percentage = mk.original_test(merged_df['Percentage'])
#     print(topic)
#     print("\nMann-Kendall Test for Percentage:")
#     print("Trend: ", mk_result_percentage.trend)  # Increasing or Decreasing
#     print("p-value: ", mk_result_percentage.p)  # p-value
#     print("Z-value: ", mk_result_percentage.z)  # Z-value

#     alpha = 0.05 
#     # if mk_result_count.p < alpha:
#     #     print("The trend in Count is statistically significant.")
#     # else:
#     #     print("The trend in Count is not statistically significant.")

#     if mk_result_percentage.p < alpha:
#         print("The trend in Percentage is statistically significant.")
#     else:
#         print("The trend in Percentage is not statistically significant.")
...
#     ax1.set_ylabel('#', color='#003f5c', fontsize=14)
#     ax2.set_ylabel('%', color='#ffa600', fontsize=14)

#     y_ticks_ax1 = ax1.get_yticks()
#     ax1.set_yticklabels(y_ticks_ax1, fontsize=11)

#     y_ticks_ax2 = ax2.get_yticks()
#     odd_ticks_ax2 = [tick for i, tick in enumerate(y_ticks_ax2) if i % 2 == 0]
#     ax2.set_yticks(odd_ticks_ax2)
#     ax2.set_yticklabels(odd_ticks_ax2, fontsize=11)
...
#     plt.xticks([2008, 2012, 2016, 2020, 2024], fontsize=13)

#     plt.show()
    
#     # # safe_topic_name = "".join([c if c.isalnum() else "_" for c in topic])
#     # # plt.savefig(f'{output_dir}/{safe_topic_name}_line_chart_step3-3.pdf')
#     # # plt.close(fig) 
